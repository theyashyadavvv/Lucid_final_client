  ...
  return (
    <div className="min-h-screen glow-background custom-cursor relative">
      ...
      <main className="relative z-10 min-h-screen flex flex-col">
        {/* Hero Section */}
        <section className="flex-1 flex items-center justify-center px-3 sm:px-4 md:px-6 pt-20 sm:pt-24 md:pt-28">
          <div className="text-center max-w-6xl mx-auto w-full">
            {/* Main Logo */}
            <div className="mb-12 sm:mb-16 md:mb-20 opacity-0 animate-fade-in-up animate-delay-500">
              <div className="flex items-center justify-center mb-6 sm:mb-8">
                <div className="relative w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-48 lg:h-48 animate-logo-glow">
                  <Image
                    src="/images/lucid-logo.png"
                    alt="Lucid Studio Logo"
                    fill
            ...
            <div className="opacity-0 animate-fade-in-up animate-delay-800 mb-8 sm:mb-10 md:mb-12">
            ...
            <div className="opacity-0 animate-fade-in-up animate-delay-1200">
              <div className="flex flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-12 text-sm sm:text-base md:text-lg lg:text-xl font-mono text-gray-300 mb-12 sm:mb-16 md:mb-20">
                {["CGI", "AI", "MOBILE", "WEB"].map((service, index) => (
                  <button
                    key={service}
            ...
            {selectedService && (
              <div className="opacity-0 animate-fade-in-up animate-delay-300 mb-12 sm:mb-16 md:mb-20">
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-4 sm:bottom-6 md:bottom-8 left-1/2 transform -translate-x-1/2 opacity-0 animate-fade-in-up animate-delay-2000">
          <div className="flex flex-col items-center space-y-1 sm:space-y-2 text-gray-400">
            <span className="font-mono text-xs">SCROLL</span>
            <div className="w-px h-6 sm:h-8 bg-gradient-to-b from-orange-500 to-transparent animate-pulse"></div>
          </div>
        </div>
      </main>

      {/* About Preview Section */}
      <section className="relative z-10 section-padding px-3 sm:px-4 md:px-6">
